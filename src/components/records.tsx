...
export function RecordsPage({ readings }: RecordsPageProps) {
    ...
    const getHeartRateCategory = (heartRate: number) => {
        if (heartRate < 50) {
            return { category: "Bradicardia", color: "destructive" }
        } else if (heartRate >= 50 && heartRate < 60) {
            return { category: "Baixo", color: "secondary" }
        } else if (heartRate >= 60 && heartRate <= 100) {
            return { category: "Normal", color: "default" }
        } else if (heartRate > 100 && heartRate <= 120) {
            return { category: "Elevado", color: "secondary" }
        } else {
            return { category: "Taquicardia", color: "destructive" }
        }
    }
    ...
    const exportData = () => {
        const csvContent = [
            ["Data/Hora", "Sistólica", "Diastólica", "Batimentos", "Categoria PA", "Categoria FC", "Observações"],
